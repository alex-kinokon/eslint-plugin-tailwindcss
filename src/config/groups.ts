...
export interface GroupParentNode extends GroupBaseNode {
  readonly members: readonly GroupNode[];
}
export interface GroupLeafNode extends GroupBaseNode {
  readonly members: string;
}

export type GroupNode = GroupParentNode | GroupLeafNode;
...
export const groups: GroupNode[] = [
  ...
  },
  {
    ...
    members: [
      ...
      {
        type: "Break After",
        members: String.raw`break\-after\-(?<value>auto|avoid|all|avoid\-page|page|left|right|column)`,
      },
      {
        type: "Break Before",
        members: String.raw`break\-before\-(?<value>auto|avoid|all|avoid\-page|page|left|right|column)`,
      },
      {
        type: "Break Inside",
        members: String.raw`break\-inside\-(?<value>auto|avoid|avoid\-page|avoid\-column)`,
      },
      {
        type: "Box Decoration Break",
        members: String.raw`box\-decoration\-(?<value>clone|slice)`,
      },
      {
        type: "Deprecated Box Decoration Break",
        members: String.raw`decoration\-(?<value>clone|slice)`,
        deprecated: true,
      },
      {
        type: "Box Sizing",
        members: String.raw`box\-(?<value>border|content)`,
      },
      {
        type: "Display",
        members: String.raw`block|flex|grid|flow\-root|contents|hidden|inline(\-(block|flex|table|grid))?|table\-(column|footer|header|row)\-group|table(\-(caption|row|cell|column))?|list\-item`,
      },
      {
        type: "Floats",
        members: String.raw`float\-(?<value>right|left|none)`,
      },
      {
        type: "Clear",
        members: String.raw`clear\-(?<value>left|right|both|none)`,
      },
      {
        type: "Isolation",
        members: String.raw`(isolate|isolation\-auto)`,
      },
      {
        type: "Object Fit",
        members: String.raw`object\-(?<value>contain|cover|fill|none|scale\-down)`,
      },
      {
      ...
      },
      {
        ...
        members: [
          {
            type: "overflow",
            members: String.raw`overflow\-(?<value>auto|hidden|clip|visible|scroll)`,
            shorthand: "all",
            body: "overflow",
          },
          {
            type: "overflow-x",
            members: String.raw`overflow\-x\-(?<value>auto|hidden|clip|visible|scroll)`,
            shorthand: "x",
            body: "overflow-x",
          },
          {
            type: "overflow-y",
            members: String.raw`overflow\-y\-(?<value>auto|hidden|clip|visible|scroll)`,
            shorthand: "y",
            body: "overflow-y",
          },
        ],
      },
      {
        ...
        members: [
          {
            type: "overscroll",
            members: String.raw`overscroll\-(?<value>auto|contain|none)`,
            shorthand: "all",
            body: "overscroll",
          },
          {
            type: "overscroll-x",
            members: String.raw`overscroll\-x\-(?<value>auto|contain|none)`,
            shorthand: "x",
            body: "overscroll-x",
          },
          {
            type: "overscroll-y",
            members: String.raw`overscroll\-y\-(?<value>auto|contain|none)`,
            shorthand: "y",
            body: "overscroll-y",
          },
        ],
        ...
        members: [
          {
            type: "inset",
            members:
              "(inset\\-(?<value>${inset})|\\-inset\\-(?<negativeValue>${-inset}))",
            shorthand: "all",
            body: "inset",
            configKey: "inset",
          },
          {
            type: "inset-y",
            members:
              "(inset\\-y\\-(?<value>${inset})|\\-inset\\-y\\-(?<negativeValue>${-inset}))",
            shorthand: "y",
            body: "inset-y",
            configKey: "inset",
          },
          {
            type: "inset-x",
            members:
              "(inset\\-x\\-(?<value>${inset})|\\-inset\\-x\\-(?<negativeValue>${-inset}))",
            shorthand: "x",
            body: "inset-x",
            configKey: "inset",
          },
          ...
          },
          {
            type: "right",
            members:
              "(right\\-(?<value>${inset})|\\-right\\-(?<negativeValue>${-inset}))",
            shorthand: "r",
            body: "right",
            configKey: "inset",
          },
          {
            type: "bottom",
            members:
              "(bottom\\-(?<value>${inset})|\\-bottom\\-(?<negativeValue>${-inset}))",
            shorthand: "b",
            body: "bottom",
            configKey: "inset",
          },
  ...
  },
  {
    ...
    members: [
      ...
      {
        type: "Flex Direction",
        members: String.raw`flex\-(row|col)(\-reverse)?`,
      },
      {
        type: "Flex Wrap",
        members: String.raw`flex\-(wrap(\-reverse)?|nowrap)`,
      },
      {
        type: "Flex",
      ...
      {
        type: "Grid Auto Flow",
        members: String.raw`grid\-flow\-(dense|(row|col)(\-dense)?)`,
      },
      {
      ...
      },
      {
        ...
        members: String.raw`justify\-(start|end|center|between|around|evenly)`,
      },
      {
        type: "Justify Items",
        members: String.raw`justify\-items\-(start|end|center|stretch)`,
      },
      {
        type: "Justify Self",
        members: String.raw`justify\-self\-(auto|start|end|center|stretch)`,
      },
      {
        type: "Align Content",
        members: String.raw`content\-(center|start|end|between|around|evenly|baseline)`,
      },
      {
        type: "Align Items",
        members: String.raw`items\-(start|end|center|baseline|stretch)`,
      },
      {
        type: "Align Self",
        members: String.raw`self\-(auto|start|end|center|stretch|baseline)`,
      },
      {
        type: "Place Content",
        members: String.raw`place\-content\-(center|start|end|between|around|evenly|stretch|baseline)`,
      },
      {
        type: "Place Items",
        members: String.raw`place\-items\-(start|end|center|stretch|baseline)`,
      },
      {
        type: "Place Self",
        members: String.raw`place\-self\-(auto|start|end|center|stretch)`,
      },
    ],
  },
  {
        ...
        members: [
          {
            type: "space-y",
            members:
              "(space\\-y\\-(?<value>${space})|\\-space\\-y\\-(?<negativeValue>${-space}))",
            configKey: "space",
          },
          {
            type: "space-x",
            members:
              "(space\\-x\\-(?<value>${space})|\\-space\\-x\\-(?<negativeValue>${-space}))",
            configKey: "space",
          },
          {
            type: "space-y-reverse",
            members: String.raw`space\-y\-reverse`,
          },
          {
            type: "space-x-reverse",
            members: String.raw`space\-x\-reverse`,
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    members: [
      ...
      {
        type: "Font Smoothing",
        members: String.raw`(subpixel\-)?antialiased`,
      },
      {
        type: "Font Style",
        members: String.raw`(not\-)?italic`,
      },
      {
        type: "Font Weight",
      ...
      },
      {
        ...
        members: [
          {
            type: "Normal Nums",
            members: String.raw`normal\-nums`,
          },
          {
            type: "Ordinal",
            members: "ordinal",
          ...
          {
            type: "Style Nums",
            members: String.raw`(lining|oldstyle)\-nums`,
          },
          {
            type: "Proportinal or Tabular",
            members: String.raw`(proportional|tabular)\-nums`,
          },
          {
            type: "Fractions",
            members: String.raw`(diagonal|stacked)\-fractions`,
          },
        ],
      },
      {
        type: "Letter Spacing",
        members:
          "(tracking\\-(?<value>${letterSpacing})|\\-tracking\\-(?<negativeValue>${-letterSpacing}))",
      ...
      },
      {
        ...
        members: String.raw`list\-(in|out)side`,
      },
      {
        type: "Text Alignment",
        members: String.raw`text\-(left|center|right|justify|start|end)`,
      },
      {
        type: "Text Color",
      ...
      },
      {
        ...
        members: String.raw`(no\-)?underline|overline|line\-through`,
      },
      {
      ...
      },
      {
        ...
        members: String.raw`decoration\-(solid|double|dotted|dashed|wavy)`,
      },
      {
      ...
      {
        type: "Text Transform",
        members: String.raw`(upper|lower|normal\-)case|capitalize`,
      },
      {
        type: "Text Overflow",
        members: String.raw`truncate|text\-(ellipsis|clip)`,
      },
      {
        type: "Deprecated Text Overflow",
        members: String.raw`overflow\-(ellipsis|clip)`,
        deprecated: true,
      },
      {
        type: "Text Wrap",
        members: String.raw`text\-(wrap|nowrap|balance|pretty)`,
      },
      {
        type: "Text Indent",
        members:
          "(indent\\-(?<value>${textIndent})|\\-indent\\-(?<negativeValue>${-textIndent}))",
        configKey: "textIndent",
      },
      {
        type: "Vertical Alignment",
        members: String.raw`align\-(baseline|top|middle|bottom|text\-(top|bottom)|sub|super)`,
      },
      {
        type: "Whitespace",
        members: String.raw`whitespace\-(normal|nowrap|pre(\-(line|wrap))?)`,
      },
      {
        type: "Word Break",
        members: String.raw`break\-(normal|words|all|keep)`,
      },
      {
        type: "Content",
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        members: String.raw`bg\-(fixed|local|scroll)`,
      },
      {
        type: "Background Clip",
        members: String.raw`bg\-clip\-(border|padding|content|text)`,
      },
      {
      ...
      },
      {
        ...
        members: String.raw`bg\-origin\-(border|padding|content)`,
      },
      {
      ...
      },
      {
        ...
        members: String.raw`bg\-(no\-repeat|repeat(\-(x|y|round|space))?)`,
      },
      {
  ...
  },
  {
    ...
    members: [
      ...
      {
        type: "Border Style",
        members: String.raw`border\-(solid|dashed|dotted|double|hidden|none)`,
      },
      {
        type: "Divide Width",
        members: [
          ...
          },
          {
            ...
            members: String.raw`divide\-y\-reverse`,
          },
          {
            type: "divide-x-reverse",
            members: String.raw`divide\-x\-reverse`,
          },
        ],
      },
      {
      ...
      {
        type: "Divide Style",
        members: String.raw`divide\-(solid|dashed|dotted|double|none)`,
      },
      {
        type: "Outline Width",
      ...
      {
        type: "Outline Style",
        members: String.raw`outline(\-(none|dashed|dotted|double|hidden))?`,
      },
      {
        type: "Outline Offset",
        members:
  ...
  },
  {
    ...
    members: [
      ...
      {
        type: "Mix Blend Mode",
        members: String.raw`mix\-blend\-(normal|multiply|screen|overlay|darken|lighten|color\-(burn|dodge)|(hard|soft)\-light|difference|exclusion|hue|saturation|color|luminosity|plus\-lighter)`,
      },
      {
        type: "Background Blend Mode",
        members: String.raw`bg\-blend\-(normal|multiply|screen|overlay|darken|lighten|color\-(dodge|burn)|(hard|soft)\-light|difference|exclusion|hue|saturation|color|luminosity)`,
      },
    ],
  },
  {
    ...
    members: [
      ...
      },
      {
        type: "Hue Rotate",
        members:
          "hue\\-rotate\\-(?<value>${hueRotate})|\\-hue\\-rotate\\-(?<negativeValue>${-hueRotate})",
        configKey: "hueRotate",
      },
      {
        type: "Invert",
    ...
    members: [
      {
        ...
        members: String.raw`border\-(collapse|separate)`,
      },
      {
        type: "Border Spacing",
        members: [
      ...
      {
        type: "Table Layout",
        members: String.raw`table\-(auto|fixed)`,
      },
    ],
  },
  {
    ...
    members: [
      {
        ...
        members: [
          {
            type: "transform-gpu",
            members: String.raw`transform\-gpu`,
          },
        ],
      },
      {
        ...
        members: [
          {
            type: "transform-none",
            members: String.raw`transform\-none`,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        members: [
          ...
          },
          {
            type: "scale-y",
            members:
              "scale\\-y\\-(?<value>${scale})|\\-scale\\-y\\-(?<negativeValue>${-scale})",
            shorthand: "y",
            body: "scale-y",
            configKey: "scale",
          },
          {
            type: "scale-x",
            members:
              "scale\\-x\\-(?<value>${scale})|\\-scale\\-x\\-(?<negativeValue>${-scale})",
            shorthand: "x",
            body: "scale-x",
            configKey: "scale",
          },
      ...
      },
      {
        type: "Rotate",
        members:
          "(rotate\\-(?<value>${rotate})|\\-rotate\\-(?<negativeValue>${-rotate}))",
        configKey: "rotate",
      },
      {
        type: "Translate",
        members: [
          {
            type: "translate-x",
            members:
              "(translate\\-x\\-(?<value>${translate})|\\-translate\\-x\\-(?<negativeValue>${-translate}))",
            configKey: "translate",
          },
          {
            type: "translate-y",
            members:
              "(translate\\-y\\-(?<value>${translate})|\\-translate\\-y\\-(?<negativeValue>${-translate}))",
            configKey: "translate",
          },
        ],
      },
        ...
        members: [
          {
            type: "skew-x",
            members:
              "(skew\\-x\\-(?<value>${skew})|\\-skew\\-x\\-(?<negativeValue>${-skew}))",
            configKey: "skew",
          },
          {
            type: "skew-y",
            members:
              "(skew\\-y\\-(?<value>${skew})|\\-skew\\-y\\-(?<negativeValue>${-skew}))",
            configKey: "skew",
          },
        ],
      },
  ...
  },
  {
    ...
    members: [
      ...
      {
        type: "Appearance",
        members: String.raw`appearance\-none`,
      },
      {
        type: "Cursor",
      ...
      {
        type: "Pointer Events",
        members: String.raw`pointer\-events\-(none|auto)`,
      },
      {
        type: "Resize",
        members: String.raw`resize(\-(none|x|y))?`,
      },
      {
        type: "Scroll Behavior",
        members: String.raw`scroll\-(auto|smooth)`,
      },
      {
        type: "Scroll Margin",
        ...
        members: [
          {
            type: "scroll-m",
            members:
              "scroll-m\\-(?<value>${scrollMargin})|\\-scroll-m\\-(?<negativeValue>${-scrollMargin})",
            configKey: "scrollMargin",
          },
          {
            type: "scroll-my",
            members:
              "scroll-my\\-(?<value>${scrollMargin})|\\-scroll-my\\-(?<negativeValue>${-scrollMargin})",
            configKey: "scrollMargin",
          },
          {
            type: "scroll-mx",
            members:
              "scroll-mx\\-(?<value>${scrollMargin})|\\-scroll-mx\\-(?<negativeValue>${-scrollMargin})",
            configKey: "scrollMargin",
          },
          {
            type: "scroll-mt",
            members:
              "scroll-mt\\-(?<value>${scrollMargin})|\\-scroll-mt\\-(?<negativeValue>${-scrollMargin})",
            configKey: "scrollMargin",
          },
          {
            type: "scroll-mr",
            members:
              "scroll-mr\\-(?<value>${scrollMargin})|\\-scroll-mr\\-(?<negativeValue>${-scrollMargin})",
            configKey: "scrollMargin",
          },
          {
            type: "scroll-mb",
            members:
              "scroll-mb\\-(?<value>${scrollMargin})|\\-scroll-mb\\-(?<negativeValue>${-scrollMargin})",
            configKey: "scrollMargin",
          },
          {
            type: "scroll-ml",
            members:
              "scroll-ml\\-(?<value>${scrollMargin})|\\-scroll-ml\\-(?<negativeValue>${-scrollMargin})",
            configKey: "scrollMargin",
          },
        ],
      },
      ...
      },
      {
        ...
        members: String.raw`snap\-(start|end|center|align-none)`,
      },
      {
        type: "Scroll Snap Stop",
        members: String.raw`snap\-(normal|always)`,
      },
      {
        type: "Scroll Snap Type",
        members: String.raw`snap\-(none|x|y|both)`,
      },
      {
        type: "Scroll Snap Type Strictness",
        members: String.raw`snap\-(mandatory|proximity)`,
      },
      {
        type: "Touch Action",
        members: [
          {
            ...
            members: String.raw`touch\-(auto|none|manipulation)`,
          },
          {
            type: "Touch Action X",
            members: String.raw`touch\-(pan\-(x|left|right))`,
          },
          {
            type: "Touch Action Y",
            members: String.raw`touch\-(pan\-(y|up|down))`,
          },
          {
            type: "Touch Action Pinch Zoom",
            members: String.raw`touch\-pinch\-zoom`,
          },
        ],
      },
      {
        type: "User Select",
        members: String.raw`select\-(none|text|all|auto)`,
      },
      {
        type: "Will Change",
  ...
  },
  {
    ...
    members: [
      {
        type: "Screen Readers",
        members: String.raw`(not\-)?sr\-only`,
      },
      {
        type: "Forced Color Adjust",
        members: String.raw`forced\-color\-adjust\-(auto|none)`,
      },
    ],
  },
  {
    ...
    members: [
      {
        ...
        members: [
          {
            type: "prose",
            members: String.raw`(not\-)?prose`,
          },
          {
            type: "Prose Gray Scale",
            members: String.raw`prose\-(gray|slate|zinc|neutral|stone)`,
          },
          {
            type: "Prose Type Scale",
            members: String.raw`prose\-(sm|base|lg|2?xl)`,
          },
          {
            type: "Prose Dark Mode",
            members: String.raw`prose\-invert`,
          },
